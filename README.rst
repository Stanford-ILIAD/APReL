...
Let's now go over a simple example of how to use **APReL**. This example is based on the `examples/simple.py <blob/main/examples/simple.py>`_ file.
...
Interested in learning other features? Take a look at a more advanced example at: `examples/advanced.py <blob/main/examples/advanced.py>`_!